...
import AccesorioOne from "../../../assets/img/products/accesorios/1/accesorio01.jpg";
import AccesorioTwo from "../../../assets/img/products/accesorios/2/accesorio02.jpg";
import AccesorioThree from "../../../assets/img/products/accesorios/3/accesorio03.jpg";
import AccesorioFour from "../../../assets/img/products/accesorios/4/accesorio04.jpg";
        ...
        <div>
          ...
          <div className="container-fluid bg-white">
            <div className="container">
              ...
              >
                {[AccesorioOne, AccesorioTwo, AccesorioThree, AccesorioFour].map(
                  (img, index) => (
