...
import RopaOne from "../../../assets/img/products/ropa/1/ropa01.jpg";
import RopaTwo from "../../../assets/img/products/ropa/2/ropa02.jpg";
import RopaThree from "../../../assets/img/products/ropa/3/ropa03.jpg";
import RopaFour from "../../../assets/img/products/ropa/4/ropa04.jpg";
     ...
     <div>
               ...
               <div className="container-fluid bg-white">
                 <div className="container">
                   ...
                   >
                     {[RopaOne, RopaTwo, RopaThree, RopaFour].map(
                       (img, index) => (
